  ...
  return (
    <>
      ...
      <p className="text-2xl font-light text-white mt-3">
        ¿Olvidaste tu contraseña? Ingresa tu correo {""}
      ...
      <form
        ...
        className="space-y-8 p-10 bg-gray-900 mt-8 rounded-xl"
        noValidate
      >
        ...
        <input
          ...
          className="bg-gray-800 hover:bg-black w-full p-3  text-white font-black  text-xl rounded-lg cursor-pointer"
        />
