  ...
  return (
    <>
      <div className="mx-auto max-w-3xl g">
        <h1 className="text-5xl font-black ">Cooperativo 🥷</h1>
        ...
        >
          ...
          <input
            ...
            className="bg-gray-800 w-full p-3 text-white uppercase font-bold hover:bg-amber-600 cursor-pointer transition-colors"
          />
        </form>
      </div>
    </>
